...
{
    $message = ''; // Definisikan variabel $message di sini
    $nik = $request->nik;
    ...
    try {
        $data = [
            ...
            'foto' => $foto,
            'password' => $password,
            'remember_token' => Str::random(10), // Atau metode lain untuk menghasilkan nilai remember_token
        ];
        ...
        if ($e->getCode() == 23000) {
            $message = " karena data dengan NIK " . $nik . " sudah ada!";
        }
