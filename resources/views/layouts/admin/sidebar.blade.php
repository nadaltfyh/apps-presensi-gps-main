<style>
    ...
    .navbar-vertical.navbar-expand-lg .navbar-collapse .dropdown-menu .dropdown-item:active {
        background: rgba(232, 227, 227, 0.06);
    }
</style>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ request()->is(['presensi/laporan', 'presensi/rekap', 'presensi/hsl-lap-kry']) ? 'show' : '' }}"
                        href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                        aria-expanded="{{ request()->is(['presensi/laporan', 'presensi/rekap','presensi/hsl-lap-kry']) ? 'true' : '' }}">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <!-- Download SVG icon from http://tabler-icons.io/i/package -->
                            <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div
                        class="dropdown-menu {{ request()->is(['presensi/laporan', 'presensi/rekap', 'presensi/hsl-lap-kry']) ? 'show' : '' }}">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                ...
                                <a class="dropdown-item {{ request()->is(['presensi/hsl-lap-kry']) ? 'active' : '' }}"
                                    href="/presensi/hsl-lap-kry">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ request()->is(['konfigurasi/lokasikantor', 'konfigurasi/jamkerja']) ? 'show' : '' }}"
                        href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                        aria-expanded="{{ request()->is(['konfigurasi/lokasikantor', 'konfigurasi/jamkerja']) ? 'true' : '' }}">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                    ...
                    <div
                        class="dropdown-menu {{ request()->is(['konfigurasi/lokasikantor', 'konfigurasi/jamkerja']) ? 'show' : '' }}">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
