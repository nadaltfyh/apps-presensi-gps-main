...
@section('content')
    ...
    <div class="jam-digital-malasngoding">
        <p>{{ date("d-m-Y") }}</p>
        <p id="jam"></p>
        <p>{{ isset($jamkerja) ? $jamkerja->nama_jam_kerja : 'Nilai Tidak Tersedia' }}</p>
        @if(isset($jamkerja) && $jamkerja->nama_jam_kerja)
    ...
    @else
        <div class="alert alert-warning mt-2">
            <p>Anda tidak dapat melakukan absen karena bukan jam kerja <strong>jam kerja</strong> tidak tersedia.</p>
        </div>
    @endif
